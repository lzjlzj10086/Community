...
public class UploadController {
    ...
    @ResponseBody
    public Object Upload(@RequestParam(value = "editormd-image-file") MultipartFile file, HttpSession session) {
        if (file == null) {
        ...
        try {
            ...
            FileDto fileDto = new FileDto(1,"上传成功",uploadMsg.getPath());
            return  fileDto;
        } catch (IOException e) {
